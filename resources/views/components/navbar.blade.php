        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="{{ route('pages.immo') }}" class="nav-item nav-link">Immobilier</a>
                    <a href="{{ route('pages.events') }}" class="nav-item nav-link">Evenementiel</a>
                    <a href="{{ route('pages.vehicule') }}" class="nav-item nav-link">Voitures</a>
